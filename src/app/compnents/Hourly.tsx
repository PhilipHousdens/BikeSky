...
export const HourlyForecast = () => {
  ...
  return (
    <div className="flex flex-col items-start justify-center w-[100%] space-y-10">
        <div className="bg-black bg-opacity-50 p-10 rounded-tr-lg rounded-br-lg">
            <p className="text-xl mb-5 text-center text-white">Chance of Rain</p>
            {rainData.timestamps.map((timestamp, index) => (
                ...
                <p className="text-lg text-white">{rainData.chances[index]}% Rain</p>
                </div>
            ))}
        </div>
    </div>
